...
sub printSlideTwo
{
	...
	print $html "<tr><td style=\"text-align:center\"><b>$snvText</b><br><img src=\"$data->{plot_dir}/$data->{tumour}-histbox-snv_count-240.png\" style=\"width:100%\"></td></tr>\n";
	print $html "<tr><td style=\"text-align:center\"><b>$indelText</b><br><img src=\"$data->{plot_dir}/$data->{tumour}-histbox-indel_count-240.png\" style=\"width:100%\"></td></tr>\n";
	print $html "<tr><td style=\"text-align:center\"><b>$svText</b><br><img src=\"$data->{plot_dir}/$data->{tumour}-histbox-sv_count-240.png\" style=\"width:100%\"></td></tr>\n";
	print $html "<tr><td style=\"text-align:center\"><b>$neoText</b><br><img src=\"$data->{plot_dir}/$data->{tumour}-histbox-neo_antigens-240.png\" style=\"width:100%\"></td></tr>\n";
